...
use graphical models.  Here we focus on discrete-state models (``Discrete Bayesian Networks''),
...
include Collapsed Gibbs Sampling (including parallel~\citep{Yan_LDA_2009} and
cluster~\citep{ClusterCGS_2012} versions) and Walker's alias method~\citep{WalkersAlias_2014}.  In a
recent result,~\citet{SAME2015} showed that by combining the State Augmented Monte Carlo (SAME)
...
applied to large-scale databases in~\citep{Zhang2013}.
