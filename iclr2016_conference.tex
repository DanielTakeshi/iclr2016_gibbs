...
%
% EDIT: Argh, we may have to re-run this to get times for four mini-batches since that's what I use for Fig 2. 
% Stout with mb size of 12.5k:
%
%
%
%
...
%
%
% Make sure we mention in the paper that we're deliberately handicapping ourselves.
\begin{table}[h]
...
\hline \hline
BIDMach Time/Iter & 0.053 & 0.077 & 0.157 & 0.306 & 0.611 \\ 
JAGS Time/Iter    & & & & & \\
\hline
\end{tabular}
\end{center}
