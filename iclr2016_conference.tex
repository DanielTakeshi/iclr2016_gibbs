...
software package that substantially out performed JAGS. % I don't think we need to reference BNT.
...
\begin{figure}[t]
  ...
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{kldiv_synthmooc_gpu_300iter_02b}
