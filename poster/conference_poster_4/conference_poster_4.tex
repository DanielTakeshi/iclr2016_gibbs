...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=6em]{berkeleylog.png}} % First university/lab logo on the left
{\bf\textsc{Fast Parallel SAME Gibbs Sampling on \\ General Discrete Bayesian Networks}\vspace{0.5em}} % Poster title
{\textsc{\{ Daniel Seita, Haoyu Chen \& John Canny \} \hspace{12pt} EECS, University of California, Berkeley} \}} % Author names and institution
{\includegraphics[height=2em]{biddatalog.png}} % Second university/lab logo on the right
...
\item Build highly optimized Gibbs sampler
\item Apply SAME strategy to reduce variance
\item Use our Gibbs sampler on synthetically generated "Koller" data and real dynamic learning map "MOOC" data to reveal our benefits.
\end{enumerate}
...
\headerbox{SAME sampling}{name=samesampling,column=1,row=0,bottomaligned=introduction}{
...
\headerbox{experiments on synthetically generated "koller" data}{name=koller,column=2,span=2,row=0}{
...
\headerbox{experiments on real dynamic learning maps "MOOC" data}{name=mooc,column=2,span=2,row=0,below=koller,above=references}{
...
\headerbox{fast gibbs sampling}{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{system implement}{name=results2,column=1,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
