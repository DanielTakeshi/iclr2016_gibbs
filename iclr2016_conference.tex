...
% Also, opts.updateAll = true because we should be updating after each minibatch.
%
...
%
% EDIT: Argh, we may have to re-run this to get times for FOUR minibatches since that's what I use
% for Fig 2. Results on stout with minibatch sizes of 12.5k:
%
...
%   (3) Also consider the batch size. We are using 2184 so we have two minibatches. More frequent
...
% informal tuning that two minibatches was appropriate.
...
%After 100 passes, the ROC has an AUC of 0.65741.  Figure~\ref{fig:mooc_accuracy} also has
...
% Koller, because we usually like to have more than one minibatch.
%
...
%
% Koller Data = (5 x 1,000,000)-dimensional, minibatch size = 50,000, iterations = 200, seed = 777.
...
% Settings: minibatch size = 400, SAME is the variable. 200 iterations and 777 seed as usual.
% Total runtimes were:
%
